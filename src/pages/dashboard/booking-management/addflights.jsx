  ...
  return (
    <section className="flex flex-col gap-6">
      <div className="flex justify-between items-center ">
        <h1 className="text-lg font-semibold">Add Flight</h1>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button
            ...
            onClick={() => navigate("/dashboard/booking-management/flights")}
          >
            {/* <Plus size={15} /> */}
            Back To Flightes
          </Button>
      ...
      <div className="flex justify-center">
        <div className="card p-4 w-full max-w-md bg-white rounded-xl shadow-md">
