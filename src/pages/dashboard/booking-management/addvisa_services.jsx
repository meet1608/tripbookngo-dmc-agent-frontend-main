...
import { Search, BellDot, CircleHelp, Settings, ChevronDown, Filter, Calendar as CalendarIcon, Plus } from 'lucide-react';
const Addvisa_service = () => {
  ...
  return (
    <section className="flex flex-col gap-6 ">
      <div className="flex justify-between items-center ">
        <h1 className="text-lg font-semibold">Add Visa Details</h1>
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <Button className="flex items-center gap-3" onClick={() => navigate("/dashboard/booking-management/visa-services")}>
            {/* <Plus size={15} /> */}
      ...
      <div className="flex justify-center">
        <div className="card p-4 w-full max-w-md bg-white rounded-xl border-2  rounded-lg shadow-md p-6">
          <h2 className="text-center text-xl font-semibold mb-4">Visa Details</h2>
...
export default Addvisa_service;